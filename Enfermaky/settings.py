"""
Django settings for Enfermaky project.
...
SECRET_KEY = 'django-insecure-*jp03h4*ab(b-a&*00lex&$^#naadiz+d7-487vgx+lehmwqjg'
...
WSGI_APPLICATION = 'Enfermaky.wsgi.application'
